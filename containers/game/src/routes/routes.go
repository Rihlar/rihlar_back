...
func InitRoutes(router *echo.Echo) *echo.Echo {
	...
	// rankingTop10
	router.GET("/ranking/top10/:game_id", controllers.GetRankingTop10Handler,middlewares.DebugRequireAuth)
	...
	//円詳細取得
	router.GET("/circle/:circle_id", controllers.GetCircleDeteileHandler,middlewares.RequireAuth)
